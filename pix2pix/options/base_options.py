...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--input_nc', type=int, default=16, help='# of input image channels: 3 for RGB and 1 for grayscale')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, help='chooses how datasets are loaded. [unaligned | aligned | single | colorization]')
        ...
        parser.add_argument('--epoch', type=str, help='which epoch to load? set to latest to use latest cached model')
        ...
        parser.add_argument('--video_folder', type=str, help='saves video here.')
